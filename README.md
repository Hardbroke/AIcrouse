...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/Hardbroke/AIcrouse) 

2.点击上面紫色`Deploy to Heroku`，会跳转到heroku app创建页面，应用程序名无需填写也能创建，名字会由heroku随机生成，选择节点（美国或者欧洲），新用户只需要自定义UUID码和CADDYIndexPage（参考：[Caddy主页配置](https://github.com/Hardbroke/AIcrouse/blob/master/README.md#5caddy%E4%B8%BB%E9%A1%B5%E9%85%8D%E7%BD%AE))，其他建议保持默认，点击下面deploy，几秒后搞定！   
...
|端口|443|
|默认UUID|b34a59ab-2ba8-4189-889b-3a762611de6c</br>**注意：务必创建时自定义UUID码**|
...
|服务器地址|自选ip（如：`uicdn.cf`或`icook.tw`）</br>应用程序名.herokuapp.com|
|端口|443|
|密码|b34a59ab-2ba8-4189-889b-3a762611de6c</br>**注意：务必创建时自定义UUID码**|
|传输协议|ws|
